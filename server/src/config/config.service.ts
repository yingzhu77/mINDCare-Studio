...
export class ConfigService {
  ...
  get crisisHotline(): string | undefined {
    return process.env.CRISIS_HOTLINE || undefined;
  }

  get crisisHotlineName(): string | undefined {
    return process.env.CRISIS_HOTLINE_NAME || undefined;
  }
}
